...
def create_or_update_data_util() -> None:
    ...
    tranform `regdep_france.parquet` to keep only reg_name, reg_code, dep_name_upper, dep_current_code, dep_status
    """
    df = pd.DataFrame(data)
    output_path = "data/opendatasoft_2024/municipality_and_departments.parquet"
