from project_functions.python.clickhouse_crud import get_clickhouse_client
import pandas as pd
...
class ClickHouseQuery:
    ...
    def load_data_to_clickhouse(self, table_name: str, data: pd.DataFrame, check_if_exists: Optional[bool] = True) -> None:
        """
